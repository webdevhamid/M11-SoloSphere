    ...
    toast((t) => (
      <div className="flex items-center gap-3">
        ...
        <div className="flex gap-2">
          <button
            className="bg-red-500 text-white p-2 font-semibold rounded-md text-xs"
            onClick={() => {
              handleDelete(id);
              toast.dismiss(t.id);
            }}
          ...
          <button
            className="bg-green-500 text-white p-2 font-semibold rounded-md text-xs"
